  ...
  render(){
   ...
   return (
      ...
      <div >
       ...
       {/* {this.state.navbar ? <Navigation truemodal = {this.openModal} Position = 'actives'/>:  <Navigation truemodal = {this.openModal} Position = 'Deactives'/>} */}
        <Navigation
          truemodal = {this.openModal}
          Position = ''
        />
        <Switch>
            ...
            <Route path='/facebook' exact component = {()=> {
              window.open('https://www.facebook.com/resurrectingpropertiesllc/') 
